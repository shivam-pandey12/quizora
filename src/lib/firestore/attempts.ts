...
function roomAnswersToAttemptAnswers(answers: RoomAnswer[]): AttemptAnswer[] {
  return [...answers]
    ...
    .map((answer) => ({
      ...
      selectedAnswerSummary: answer.selectedAnswerSummary,
      correctAnswerSummary: answer.correctAnswerSummary,
      textAnswer: answer.textAnswer,
      numericAnswer: answer.numericAnswer,
      blankAnswers: answer.blankAnswers,
      correctBlankAnswers: answer.correctBlankAnswers,
      matchingAnswers: answer.matchingAnswers,
      correctMatchingAnswers: answer.correctMatchingAnswers,
      orderingAnswerIds: answer.orderingAnswerIds,
      correctOrderIds: answer.correctOrderIds,
      ...
      questionImageAlt: answer.questionImageAlt,
      questionImageCaption: answer.questionImageCaption,
      optionsSnapshot: answer.optionsSnapshot,
      blanksSnapshot: answer.blanksSnapshot,
      matchPairsSnapshot: answer.matchPairsSnapshot,
      orderItemsSnapshot: answer.orderItemsSnapshot,
      unit: answer.unit,
      tolerance: answer.tolerance,
      passageTitle: answer.passageTitle,
      passageText: answer.passageText,
      assertionText: answer.assertionText,
