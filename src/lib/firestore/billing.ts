...
function mapPayment(snapshot: QueryDocumentSnapshot): PaymentRecord {
  ...
  return {
    ...
    amountPaid: asNumber(data.amountPaid, asNumber(data.amount)),
    priceINR: asNumber(data.priceINR),
    originalPriceINR: typeof data.originalPriceINR === "number" ? data.originalPriceINR : null,
